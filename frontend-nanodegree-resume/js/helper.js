...
var HTMLworkEmployer = '<a href="#" id="content-text">%data%';
var HTMLworkTitle = ' - %data%</a>';
var HTMLworkDates = '<div class="date-text" id="content-text">%data%</div>';
var HTMLworkLocation = '<div class="location-text" id="content-text">%data%</div>';
var HTMLworkDescription = '<p id="content-text"><br>%data%</p>';

var HTMLprojectStart = '<div class="project-entry"></div>';
var HTMLprojectTitle = '<a href="#" id="content-text">%data%</a>';
var HTMLprojectDates = '<div class="date-text" id="content-text">%data%</div>';
var HTMLprojectDescription = '<p id="content-text"><br>%data%</p>';
var HTMLprojectImage = '<div id="project-image"><img class="project-image" src="%data%"></div>';

var HTMLschoolStart = '<div class="education-entry"></div>';
var HTMLschoolName = '<a href="#" id="content-text">%data%';
